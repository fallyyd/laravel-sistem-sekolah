        ...
                <div class="mx-auto flex max-w-5xl items-center justify-between px-6 py-5">
            ...
                        <a href="" class="flex items-center gap-3">
                ...
                                <span>
                    ...
                                        <span class="font-display block text-lg font-semibold leading-none">Sistem
                        Sekolah</span>

                                        <span class="text-[11px] uppercase tracking-[0.2em] text-white/50">Buku Induk
                        Siswa</span>
        ...
                <div class="border border-[#E5E3DB] bg-white">
            ...
                        <table class="w-full text-left text-sm">
                ...
                                <thead>
                    ...
                                        <tr
                        class="border-b border-[#16213A] text-[11px] uppercase tracking-[0.15em] text-[#16213A]">
